...
@safe class Http1xParserExcetion : Exception {
    ...
    {
        _parserError = error;
        super(error_string[error], file, line, next);
    }

    HTTPParserErrno parserError(){return _parserError;}
private:
    HTTPParserErrno _parserError = HTTPParserErrno.HPE_OK;
}
...
enum char[256] tokens = [ /*   0 nul    1 soh    2 stx    3 etx    4 eot    5 enq    6 ack    7 bel  */
...
enum byte[256] unhex = [-1, -1, -1, -1, -1, -1, -1,
...
enum ubyte[32] normal_url_char = [ /*   0 nul    1 soh    2 stx    3 etx    4 eot    5 enq    6 ack    7 bel  */
0 | 0 | 0 | 0 | 0 | 0 | 0 | 0, /*   8 bs     9 ht    10 nl    11 vt    12 np    13 cr    14 so    15 si   */
